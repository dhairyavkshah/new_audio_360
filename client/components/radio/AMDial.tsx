      ...
      <View style={styles.sliderContainer}>
        ...
        <View style={styles.sliderWrapper}>
          <CrossPlatformSlider
            ...
            accessibilityLabel="AM Frequency tuner"
            accessibilityHint="Tune to an AM frequency"
          />
        </View>
        <FluentText variant="caption1" color="secondary">
          {AM_MAX} kHz
...
export const AMDial = memo(AMDialComponent);
