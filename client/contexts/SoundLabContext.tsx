...
const EQ_PRESETS: Record<string, number[]> = {
  ...
  Rock: [2, 2, 1, 0, 0, 1, 2, 3, 2, 1],
  Pop: [2, 2, 1, 1, 1, 2, 2, 2, 1, 1],
  Jazz: [1, 1, 0, 2, 2, 1, 0, 1, 1, 0],
  Classical: [0, 0, 1, 1, 1, 1, 1, 2, 2, 2],
  Electronic: [3, 3, 2, 0, 0, 1, 2, 3, 2, 1],
  'Hip-Hop': [4, 4, 2, 0, 1, 1, 2, 1, 0, 0],
  Acoustic: [1, 1, 0, 2, 3, 3, 2, 1, 1, 0],
  'Bass+': [5, 4, 3, 1, 0, 0, 0, 0, 1, 1],
  Clarity: [0, 0, 1, 1, 2, 2, 3, 3, 4, 3],
};
