      ...
      >
        ...
        <GlassCard style={styles.descriptionCard}>
          <FluentText variant="caption1" color="secondary" style={styles.description}>
            ...
            audio engine, custom 10-band EQ, psychoacoustic spatial enhancement, and immersive sound modes.
          </FluentText>
        </GlassCard>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.featuresList}>
            ...
            <FeatureItem
              ...
              description="6 modes with psychoacoustic spatial enhancement"
              colors={colors}
              isDark={isDark}
            />
          </View>
