...
const IMMERSIVE_MODES: Record<string, ImmersiveMode> = {
  music: {
    name: 'Music',
    eqPreset: [+1.00, +0.80, +0.40, -0.30, -0.30, +0.10, +0.50, +0.60, +0.30, -1.10],
    reverb: 0.08,
  ...
  '360_reality': {
    name: '360 Reality',
    eqPreset: [+0.80, +0.60, +0.20, -0.20, -0.20, +0.40, +0.70, +0.70, +0.40, -0.80],
    reverb: 0.17,
    spatialEnhancement: 5,
    spatialParams: { sideGain: 15, itdMs: 0.45, decorrelation: 13, wetMix: 63 },
  },
  gaming: {
    name: 'Gaming',
    eqPreset: [+1.20, +1.00, +0.50, -0.50, -0.60, +0.20, +0.80, +0.90, +0.60, -1.80],
    reverb: 0.07,
    spatialEnhancement: 3,
    spatialParams: { sideGain: 15, itdMs: 0.35, decorrelation: 9, wetMix: 60 },
  },
  podcast: {
    name: 'Podcast',
    eqPreset: [-1.10, -0.80, -0.20, +0.30, +1.30, +1.50, +1.00, +0.80, +0.70, -1.70],
    reverb: 0,
  ...
  movie: {
    name: 'Movie',
    eqPreset: [+0.70, +0.60, +0.30, +0.90, +1.30, +1.30, +0.80, -0.30, -0.50, -1.50],
    reverb: 0.14,
    spatialEnhancement: 4,
    spatialParams: { sideGain: 12, itdMs: 0.30, decorrelation: 10, wetMix: 52 },
  },
  sports: {
    name: 'Sports',
    eqPreset: [+1.10, +0.90, +0.40, -0.20, -0.20, +0.30, +0.50, +0.30, -0.60, -1.70],
    reverb: 0.11,
    spatialEnhancement: 2,
    spatialParams: { sideGain: 13, itdMs: 0.28, decorrelation: 9, wetMix: 52 },
  },
};
