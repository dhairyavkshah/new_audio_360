...
export const PremiumEffectsModule = {
  isAvailable: () => false,
  setPBEEnabled: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
  setPBEIntensity: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
  setSBREnabled: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
  setSBRIntensity: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
  setDynamicEQEnabled: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
  setDynamicEQStrength: (): PremiumEffectsResult => ({ success: false, error: 'Not available on web' }),
